...
namespace CloudBanking.UITestApp
{
    ...
    public partial class TestActivity : BaseActivity, IGatewayDownloadCallbackListener
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            {
                //Window.SetStatusBarColor(this.GetThemeStatusBarColor());
        ...
        void StartApplication()
        {
            ...
            //DialogBuilder.Theme = UtilEnum.AppTheme.MiniDonation;
            //GlobalData.CurrentMerchantConfig().GlobalPaymentMode.FNCFlows = FNCFlows.MiniDonation;
        ...
        void InitSplitPayData()
        {
            ...
            _lData.Add(new ScreenViewModel()
            {
                Title = $"CommonReviewDialog MultiTender ver02",
                RightIconResName = "",
                ItemAction = new Action(() =>
                {
        ...
        void InitCommonDialogsData()
        {
            ...
            _lData.Add(new ScreenViewModel()
            {
                Title = $"SinatureApproval",
                RightIconResName = "",
                ItemAction = new Action(() =>
                {
                    ShowSinatureApproval();
                })
            });
            ...
            _lData.Add(new ScreenViewModel()
            {
                Title = $"MessageDialog Reprint false",
                RightIconResName = "",
                ItemAction = new Action(() =>
                {
                    ShowReprintMessageBox01();
                })
            });

            _lData.Add(new ScreenViewModel()
            {
                Title = $"MessageDialog Reprint true",
                RightIconResName = "",
                ItemAction = new Action(() =>
                {
                    ShowReprintMessageBox02();
                })
            });

            //_lData.Add(new ScreenViewModel()
            //{
            //    Title = $"MessageDialog VoidTransaction",
            //    RightIconResName = "",
            //    ItemAction = new Action(() =>
            //    {
            //        ShowMessageDialogVoidTransaction();
            //    })
            //});
            ...
            //_lData.Add(new ScreenViewModel()
            //{
            //    Title = $"MessageDialog InvalidAmount",
            //    RightIconResName = "",
            //    ItemAction = new Action(() =>
            //    {
            ...
            _lData.Add(new ScreenViewModel()
            {
                Title = $"DynamicOptionDialog CASE4",
                RightIconResName = "",
                ItemAction = new Action(() =>
                {
            ...
            _lData.Add(new ScreenViewModel()
            {
                Title = $"DynamicOptionDialog CASE5",
                RightIconResName = "",
                ItemAction = new Action(() =>
                {
            ...
            _lData.Add(new ScreenViewModel()
            {
                Title = $"DynamicOptionDialog CASE6",
                RightIconResName = "",
                ItemAction = new Action(() =>
                {
        ...
        void InitSettleReprintFlowData()
        {
        ...
        private void InitializeCommonData()
        {
...
#if false // khong co trong v2
            
            #region Customer 
            
            _lData.Add(new ScreenViewModel()
            {
                Title = $"SendReceiptCustomerDialog",
                RightIconResName = "",
                ItemAction = new Action(() =>
                {
                    ShowSendReceiptCustomerDialog();
                })
            });
            ...
            _lData.Add(new ScreenViewModel()
            {
                Title = $"ReviewCustomerDialog",
                RightIconResName = "",
                ItemAction = new Action(() =>
                {
                    ShowReviewCustomerDialog();
                })
            });

            _lData.Add(new ScreenViewModel()
            {
                Title = $"SelectCustomerDialog",
                RightIconResName = "",
                ItemAction = new Action(() =>
                {
            ...
            //_lData.Add(new ScreenViewModel()
            //{
            //    Title = $"EzipayTransactions",
            //    RightIconResName = "",
            //    ItemAction = new Action(() =>
            //    {
            //        ShowEzipayTransactions();
            //    })
            //});

            //_lData.Add(new ScreenViewModel()
            //{
            //    Title = $"MessageDialog GiftRedeem",
            //    RightIconResName = "",
            //    ItemAction = new Action(() =>
            //    {
            //        ShowMessageDialogGiftRedeem();
            //    })
            //});

            //_lData.Add(new ScreenViewModel()
            //{
            //    Title = $"MessageDialog GiftCardSale",
            //    RightIconResName = "",
            //    ItemAction = new Action(() =>
            //    {
            //        ShowMessageDialogGiftCardSale();
            //    })
            //});

            //_lData.Add(new ScreenViewModel()
            //{
            //    Title = $"MessageDialog GiftCardBalance",
            //    RightIconResName = "",
            //    ItemAction = new Action(() =>
            //    {
            //        ShowMessageDialogGiftCardBalance();
            //    })
            //});
            ...
            _lData.Add(new ScreenViewModel()
            {
                ...
                ItemAction = new Action(() =>
                {
                    ShowManualEntryCardNumberDialog();
                })
            });

            //_lData.Add(new ScreenViewModel()
            //{
            //    Title = $"SoftKeyboardInputDialog",
            //    RightIconResName = "",
            //    ItemAction = new Action(() =>
            //    {
            //        ShowSoftKeyboardInputDialog();
            //    })
            //});
            ...
            _lData.Add(new ScreenViewModel()
            {
                Title = $"CheckItemsDialog",
                RightIconResName = "",
                ItemAction = new Action(() =>
                {
                    ShowCheckItemsDialog();
                })
            });
